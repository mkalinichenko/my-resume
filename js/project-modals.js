...
const projectModalProTest = document.querySelector('#personal-project-pro-test');
...
const projectModals = [ projectModalFullStack, projectModalWeddingProject, projectModalProTest, projectModalProjectGoit, projectModalQuestify, projectModalItTest];
