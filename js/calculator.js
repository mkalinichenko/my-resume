...
const technologiesMultiSelect = new Choices(technologiesSelect, {
  ...
  function calculateSum() {
    ...
    const websiteCart = document.querySelector('#calculator-form-radio-cart input:checked');
    const websiteReception = document.querySelector('#calculator-form-radio-reception input:checked');
